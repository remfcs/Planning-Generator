...
def generate_professors_pdf():
    ...
    output_path = os.path.join(EXPORT_FOLDER, 'Professors_List.pdf')
    absolute_output_path = os.path.abspath(output_path)
    ...
    return send_file(absolute_output_path, as_attachment=True, download_name='Professors_List.pdf')
...
def generate_professor_pdf(professor_name):
    ...
    output_path = os.path.join(EXPORT_FOLDER, f'professor_{professor_name}.pdf')
    absolute_output_path = os.path.abspath(output_path)
