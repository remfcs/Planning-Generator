...
#                                 Restore BackUp                                   #
####################################################################################
# Provides functionalities to restore backup.                                      #
####################################################################################
...
def restore_backup(Data):
    try:
        ...
        # Logging the constructed backup filename
        print(f"Constructed backup filename: {rename_data}")

        # Checking if the backup exists
        if os.path.exists(rename_data):
            print("Backup file found. Proceeding with restoration...")
            
            # Deleting the current database file
            os.remove(Data)
            print("Current database file deleted.")
