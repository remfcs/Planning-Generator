...
def make_association(Data, promo_pair):
    ...
    for promo_list in promo_pair:
        ...
        for value in final_insertions:
            result_str = ', '.join(promo_list)
            cursor.execute("INSERT INTO Courses(LANGUAGE, ID_COURSE, ID_TEACHER, ID_AVAILABILITY, ID_ROOM, PROMO) VALUES(?,?,?,?,?,?);", (value[3], value[1], value[0], value[2], value[4], result_str))
